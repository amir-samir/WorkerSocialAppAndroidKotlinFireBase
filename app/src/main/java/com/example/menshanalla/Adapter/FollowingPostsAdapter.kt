...
/**
 * this is the child adapter of the post of followings recyclerView.
 *
 * @author Amir Azim
 *
 *
...
class FollowingPostsAdapter (
    private var mContext: Context,
    private var posts: Posts,
    private var isFragment: Boolean = false

): RecyclerView.Adapter<FollowingPostsAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return FollowingPostsAdapter.ViewHolder(view)
    }
